...
(function(){
  ...
  function toggleToolsMenu(anchor){
    ...
    menu.style.cssText = 'position:fixed;top:'+(rect.bottom+8)+'px;right:'+(window.innerWidth - rect.right)+'px;z-index:99999;background:#161a2e;border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:6px;min-width:220px;box-shadow:0 18px 40px rgba(0,0,0,.6);animation:t3-toolsmenu-in .18s ease forwards;transform-origin:top right';
    function item(emoji, label, click, color){
      var i = document.createElement('button');
      i.style.cssText = 'display:flex;align-items:center;gap:10px;width:100%;background:none;border:0;color:#cbd5e1;padding:10px 12px;text-align:left;cursor:pointer;font-size:13px;border-radius:8px;transition:background .12s';
      i.onmouseenter = function(){ i.style.background = 'rgba(255,255,255,.05)'; };
      i.onmouseleave = function(){ i.style.background = ''; };
      i.innerHTML = '<span style="font-size:18px;width:24px;text-align:center;color:'+(color||'#cbd5e1')+'">'+emoji+'</span><span>'+label+'</span>';
