...
(function(){
  ...
  var css = ''
    ...
    + '#t3-puzzles.t3-vertical{position:fixed !important;left:0;top:0;bottom:0;width:90px;flex-direction:column !important;display:flex !important;background:#0a0e1a;border-right:1px solid rgba(255,255,255,.05);padding:14px 8px;gap:4px;overflow-y:auto;z-index:100;align-items:stretch;justify-content:flex-start;border-radius:0;box-sizing:border-box}'
    + '#t3-puzzles.t3-vertical button{width:100%;padding:10px 6px;font-size:13px;border-radius:8px;background:none;border:0;color:#94a3b8;cursor:pointer;font-weight:600;transition:all .15s;flex:0 0 auto;line-height:1.2;text-align:center;font-family:inherit}'
    ...
    + 'body.t3-sidebar-active #t3den-app{margin-left:90px;padding-left:14px}'
    + 'body.t3-sidebar-active #t3-fmc-mode{margin-left:90px}'
    + '@media (max-width:640px){#t3-puzzles.t3-vertical{width:60px;padding:10px 4px}#t3-puzzles.t3-vertical button{padding:8px 4px;font-size:11px}body.t3-sidebar-active #t3den-app{margin-left:60px}}'
  ...
  function transformTimerLayout(){
    ...
    if (!puzzles || puzzles.classList.contains('t3-vertical')) return;
