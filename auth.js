...
(function(){
  ...
  function applyTheme(themeName){
    ...
    style.textContent = ''
      ...
      // Timer page red elements
      + '#t3-puzzles button.active,#t3-puzzles button[style*="ef4444"]{background:'+theme.accentBg+' !important;color:'+theme.accent+' !important}'
      + '#t3-timer{color:#fff}'
      + '#t3-scramble{color:'+theme.accent+' !important}'
      // Charts red lines
      + '#t3-chart-line,#t3-chart-hist{filter:hue-rotate('+(themeName==='blue'?'220deg':'0deg')+')}'
      // Auth UI
