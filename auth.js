...
(function(){
  ...
  function toggleToolsMenu(anchor){
    ...
    menu.style.cssText = 'position:fixed;top:'+(rect.bottom+8)+'px;right:'+(window.innerWidth - rect.right)+'px;z-index:99999;background:#161a2e;border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:6px;min-width:220px;box-shadow:0 18px 40px rgba(0,0,0,.6);animation:t3-celebrate-in .25s ease forwards';
