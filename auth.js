...
(function(){
  ...
  var css = ''
    ...
    + '.t3-auth-badge{position:fixed;top:14px;right:240px;background:rgba(0,0,0,.5);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.08);border-radius:999px;padding:6px 14px;display:flex;align-items:center;gap:10px;z-index:9000;font-size:13px;color:#e2e8f0}'
  ...
  function buildBadge(user){
    ['t3-auth-badge','t3-trophy','t3-sync','t3-feed-icon','t3-bell-icon'].forEach(function(id){ var x=document.getElementById(id); if(x)x.remove(); });
