...
(function(){
  ...
  var css = ''
    ...
    + 'body.t3-sidebar-active #t3den-app{margin-left:70px;padding-left:8px}'
    + 'body.t3-sidebar-active #t3-fmc-mode{margin-left:70px}'
    + '@media (max-width:640px){#t3-puzzles.t3-vertical{width:50px;padding:8px 2px}#t3-puzzles.t3-vertical button{padding:6px 2px;font-size:10px}body.t3-sidebar-active #t3den-app{margin-left:50px;padding-left:4px}}'
