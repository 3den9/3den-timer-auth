...
(function(){
  ...
  function applyTheme(themeName){
    ...
    style.textContent = ''
      ...
      + '/* Override any inline style with red — but EXCLUDE cube preview stickers (they need to stay red as a cube color) */ '
      + ':not(#t3-preview-wrap):not(#t3-preview-wrap *):not(.t3-cube-svg):not(.t3-cube-svg *):not(.t3-stickers):not(.t3-stickers *)[style*="background-color: rgb(239, 68, 68)"],'
      + ':not(#t3-preview-wrap):not(#t3-preview-wrap *):not(.t3-cube-svg):not(.t3-cube-svg *):not(.t3-stickers):not(.t3-stickers *)[style*="background:#ef4444"],'
      + ':not(#t3-preview-wrap):not(#t3-preview-wrap *):not(.t3-cube-svg):not(.t3-cube-svg *):not(.t3-stickers):not(.t3-stickers *)[style*="background: rgb(239, 68, 68)"]{background:'+theme.accent+' !important;background-color:'+theme.accent+' !important}'
      + ':not(#t3-preview-wrap):not(#t3-preview-wrap *)[style*="color: rgb(239, 68, 68)"],:not(#t3-preview-wrap):not(#t3-preview-wrap *)[style*="color:#ef4444"]{color:'+theme.accent+' !important}'
      + ':not(#t3-preview-wrap):not(#t3-preview-wrap *)[style*="border-color: rgb(239, 68, 68)"],:not(#t3-preview-wrap):not(#t3-preview-wrap *)[style*="border-color:#ef4444"]{border-color:'+theme.accent+' !important}'
      + '/* Force cube preview stickers to never be themed */ '
