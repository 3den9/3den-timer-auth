...
(function(){
  ...
  /* ---- TOOLBAR ICONS (race, badges, compare) ---- */
  function injectMegaIcons(){
    ...
    function makeIcon(id, emoji, title, right, color, click){
    ...
    // Place these to the LEFT of the streak icon (which is at right:664)
    makeIcon('t3-race-icon', '🏁', 'Cube Race target', 714, '#22c55e', showRaceModal);
    makeIcon('t3-badges-icon', '🎖', 'Badges & Goals', 764, '#fbbf24', showBadgesModal);
    makeIcon('t3-compare-icon', '📊', 'Session Compare', 814, '#3b82f6', showCompareModal);
    makeIcon('t3-subx-icon', '🎯', 'Sub-X Tracker', 864, '#a855f7', showSubXModal);
    makeIcon('t3-predict-icon', '🔮', 'Predict your time (mini-game)', 914, '#ec4899', openPredictModal);
    makeIcon('t3-sound-icon', SOUND_ENABLED?'🔊':'🔇', 'Toggle sound effects', 964, '#cbd5e1', function(){
      setSoundEnabled(!SOUND_ENABLED);
      var i = document.getElementById('t3-sound-icon');
      if (i) i.innerHTML = SOUND_ENABLED?'🔊':'🔇';
    });
  }
