...
(function(){
  ...
  function applyTheme(themeName){
    ...
    style.textContent = ''
      ...
      + '/* Override any inline style with red */ '
      + '[style*="background-color: rgb(239, 68, 68)"],[style*="background:#ef4444"],[style*="background: rgb(239, 68, 68)"]{background:'+theme.accent+' !important;background-color:'+theme.accent+' !important}'
      + '[style*="color: rgb(239, 68, 68)"],[style*="color:#ef4444"]{color:'+theme.accent+' !important}'
      + '[style*="border-color: rgb(239, 68, 68)"],[style*="border-color:#ef4444"]{border-color:'+theme.accent+' !important}'
