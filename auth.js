...
(function(){
  ...
  function buildBadge(user){
    ['t3-auth-badge','t3-trophy','t3-sync','t3-feed-icon','t3-bell-icon','t3-daily-icon','t3-weekly-icon','t3-inbox-icon','t3-lib-icon','t3-help-icon'].forEach(function(id){ var x=document.getElementById(id); if(x)x.remove(); });
