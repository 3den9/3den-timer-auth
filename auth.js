...
(function(){
  ...
  function renderAlgsOLL(){
    ...
    var html = '<div style="max-width:1300px;margin:0 auto">'
      + '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px">'
      + '  <a href="/" style="color:#94a3b8;text-decoration:none;font-size:14px">← Back to timer</a>'
      + '  <h1 style="margin:0;font-size:28px;font-weight:800">📚 <span style="color:#a855f7">OLL</span> Library</h1>'
      + '  <a href="/algs?set=pll" style="background:rgba(6,182,212,.15);border:1px solid #06b6d4;color:#06b6d4;padding:8px 16px;border-radius:8px;cursor:pointer;font-weight:600;text-decoration:none;font-size:14px">PLL →</a>'
      + '</div>'
